...
pfQuest_defconfig = {
  ...
  { text = L["Progressive Route Transparency"],
    default = "0", type = "checkbox", config = "progressivetransparency" },
  { text = L["Route Color (RRGGBB)"],
    default = "D4AF37", type = "text", config = "routecolor" },
